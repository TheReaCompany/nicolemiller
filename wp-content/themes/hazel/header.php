...
<head>
	<!-- Pinterest -->
	<meta name="p:domain_verify" content="6fea0f927da4fdc4f7d64efba1ee4b2b"/>
...
<body <?php body_class(); ?>>
	...
	<!-- GA code added directly by Alexander Rea 12/18/14 -->
	<?php include_once("nmad_tracking.php") ?>
			...
			<div class="container">
				<div class="container_inner clearfix">
					...
					<div class="header_inner_left">
						...
						<?php if(has_nav_menu('top-navigation') || has_nav_menu('left-top-navigation') || has_nav_menu('right-top-navigation')) { ?>
...
<?php } else{?>
	<header class="page_header <?php if($display_header_top == "yes"){ echo 'has_top'; }  if($header_top_area_scroll == "yes"){ echo ' scroll_top'; }?> <?php echo $header_bottom_appearance; ?>  <?php echo $header_style; ?> <?php if(is_active_sidebar('header_fixed_right')) { echo 'has_header_fixed_right'; } ?>">
		<?php if(isset($qode_toolbar)) include("toolbar.php") ?>
		<div class="header_inner clearfix">
			<div class="header_bottom clearfix" <?php echo $header_color_per_page; ?> >
				<?php if($header_in_grid){ ?>
...
if(get_post_meta($id, "qode_revolution-slider", true) == "" && !$is_title_area_visible && !is_category() && !is_tag() && !is_author()){
	if($qode_options['header_bottom_appearance'] == "fixed"){
