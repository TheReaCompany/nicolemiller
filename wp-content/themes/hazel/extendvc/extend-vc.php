...
vc_map( array(
		...
		"params" => array(
			...
			array(
				"type" => "dropdown",
				"class" => "",
				"heading" => "Separator After Title",
				"param_name" => "separator_after_title",
				"value" => array(
					""   => "",
					"Yes" => "yes",
					"No" => "no"
			...
			array(
				...
				"description" => "",
				"dependency" => array('element' => 'separator_after_title', 'value' => 'yes')
			),
			array(
				"type" => "textfield",
				"holder" => "div",
			...
			array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => "Features icons background color",
				"param_name" => "features_icons_background_color",
				"description" => ""
			),
			array(
				"type" => "colorpicker",
...
vc_map( array(
		...
		"params" => array(
            ...
            array(
                ...
                "holder" => "div",
                "class" => "",
                "heading" => "Top Padding (px)",
                "param_name" => "top_padding",
                "description" => "Default value is 35"
            ),
            array(
                "type" => "textfield",
                "holder" => "div",
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "15,#ecae80,Legend One; 35,#ffbe8d,Legend Two; 50,#ffd1ae,Legend Three",
				"description" => ""
			)
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"heading" => "Content",
				"param_name" => "content",
				"value" => "#ecae80,Legend One,1,5,10;#ffbe8d,Legend Two,3,7,20;#ffd1ae,Legend Three,10,2,34",
				"description" => ""
			)
		)
) );
...
vc_map( array(
	...
	"params" => array(
		...
		array(
			...
			"description" => "Default value is 80. Only when Icon Position is Left",
			"dependency" => Array('element' => "fe_icon", 'not_empty' => true)
		),
		array(
			"type" => "dropdown",
...
vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"param_name" => "icon_custom_size",
				"value" => "",
				"description" => "Defaul value is 55",
				"dependency" => Array('element' => "icon_pack", 'value' => array('font_awesome','font_elegant'))
			),
			array(
				"type" => "colorpicker",
