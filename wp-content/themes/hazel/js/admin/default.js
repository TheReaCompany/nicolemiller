...
function showHideSmallTitlePosition(){
    if($j('input#qode_slide-small-title-on-bottom').is(':checked') == true){
        $j('#qode_slide-small-title-on-bottom-position').parent().show();
    }else{
        $j('#qode_slide-small-title-on-bottom-position').parent().hide();
    }
}
...
$j(document).ready(function() {
  ...
  $j( ".datepicker" ).datepicker( { dateFormat: "MM dd, yy" });
    ...
    /* show/hide field for Qode Slider small title position */
    showHideSmallTitlePosition();
    $j("input#qode_slide-small-title-on-bottom").change(function() {
        showHideSmallTitlePosition();
    });
